...
public class Student_Query_RP {
	private JFrame frame = new JFrame("学生信息管理系统");
	private JPanel jpanel;
	private ImageIcon background;
	
	public Student_Query_RP(){
		background = new ImageIcon(this.getClass().getResource("/images/bg8.jpg"));// 背景图片
		...
		JLabel title = new JLabel("我的获奖统计");
		...
		table.setColumnIdentifiers(new Object[]{"学号","姓名","学院","奖项","级别","获得时间"});
		
		new ConnectDB().student_Query_R(table,Welcome.id_s);
